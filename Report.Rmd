...
Tree based models is one of the best and mostly used learning methods. It empowers predictive models with high accuracy, stability and ease of interpretation. Unlike linear models, they map non-linear relationships quite well. They are adaptable at solving any kind of problem at hand (classification or regression), so it’s not a surprise that good results were obtained. 
