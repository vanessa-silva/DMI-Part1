...
We can collect a series of scores and provide as our estimate the average of these scores, together with the standard error of this estimate, repeating the tests 10 times.
For this we will use the Bootstrap method.
